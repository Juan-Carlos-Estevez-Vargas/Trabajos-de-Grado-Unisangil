...
import { EntityArrayResponseType, ModalityService } from '../service/modality.service';
...
export class ModalityComponent implements OnInit {
  ...
  trackId = (_index: number, item: IModality): number => this.modalityService.getModalityIdentifier(item);

  ngOnInit(): void {
    this.load();
  }

  delete(modality: IModality): void {
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.modalityService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
