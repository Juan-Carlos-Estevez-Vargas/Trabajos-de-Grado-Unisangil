...
import dev.juan.estevez.app.service.ProposalService;
...
/**
 * REST controller for managing {@link dev.juan.estevez.app.domain.Proposal}.
 */
@RestController
@RequestMapping("/api")
public class ProposalResource {
    ...
    public ResponseEntity<ProposalDTO> updateProposal(
        ...
        ProposalDTO result = proposalService.update(proposalDTO);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<List<ProposalDTO>> getAllProposals(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
