...
/**
 * REST controller for managing {@link dev.juan.estevez.app.domain.Tutor}.
 */
@RestController
@RequestMapping("/api")
public class TutorResource {
     ...
     */
    @GetMapping("/tutors")
    public ResponseEntity<List<Tutor>> getAllTutors(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
